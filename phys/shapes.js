...
var shapes = {
    Circle:function (props) {
		...
		this.draw=function () {
			...
			if (this.colorByHeight) { ctx.fillStyle = this.getColorByHeight(); }
			else if (this.colorByVelocity) { ctx.fillStyle = this.getColorByVelocity(); }
			else if (this.colorByRainbow) { ctx.fillStyle = getRandomColor(); }
